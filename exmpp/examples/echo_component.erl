...
init() ->
    ...
    exmpp_component:auth(XmppCom, "service.opengoss.com", "public"),
    {ok, _StreamId} = exmpp_component:connect(XmppCom, "localhost", 5288),
...
echo_packet(XmppCom, Packet) ->
    ...
    To = exmpp_xml:get_attribute(Packet, to, <<"service.opengoss.com">>),
